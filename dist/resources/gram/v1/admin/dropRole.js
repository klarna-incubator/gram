...
const cookieOpts = config_1.default.get("cookie");
const log = (0, logger_1.getLogger)("dropRole");
function dropRole(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (role) {
                user.roles = user.roles.filter((r) => !role.includes(r));
                const payload = {
                    roles: user.roles,
                    sub: user.sub,
                    teams: user.teams,
...
exports.default = dropRole;
//# sourceMappingURL=dropRole.js.map