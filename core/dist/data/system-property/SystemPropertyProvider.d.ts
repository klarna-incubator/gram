...
export interface SystemPropertyProvider {
     ...
     */
    provideSystemProperties(ctx: RequestContext, systemObjectId: string, quick: boolean): Promise<SystemPropertyValue[]>;
    /**
     * Used for filtering lists of systems.
     *
     * Should return a list of SystemIDs.
     */
    listSystemByPropertyValue(ctx: RequestContext, propertyId: string, value: any): Promise<string[]>;
}
//# sourceMappingURL=SystemPropertyProvider.d.ts.map