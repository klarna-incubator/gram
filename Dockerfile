FROM l-docker-klarna-production.artifactory.klarna.net/klarna/node:20.202312211136-builder AS builder
...
FROM l-docker-klarna-production.artifactory.klarna.net/klarna/node:20.202312211136
