...
- **api:** return empty resources for models without a systemId ([22b8ff6](https://github.com/klarna/gram/commit/22b8ff6626998a18bae6f6099e7af466c9127af6))

# [4.26.0](https://github.com/klarna/gram/compare/v4.25.0...v4.26.0) (2026-08-05)

### Bug Fixes

- **api:** degrade gracefully when team lookup fails at login ([651d242](https://github.com/klarna/gram/commit/651d242a003f27d182ed7940365bb7cebd462ed6))
...
- **api:** raise JSON body parser limit and document threat model JSON format for agents ([f2baf7b](https://github.com/klarna/gram/commit/f2baf7b19ccca38220c972fb5cbf83b28d261ba4))
...
- :test_tube: fix jest globals version and tests ([0d30238](https://github.com/klarna/gram/commit/0d3023867d4ad97cee9d31a5198a622f9b440811))
...
- fix path-to-route error ([9bec723](https://github.com/klarna/gram/commit/9bec723fb9a2b02fcacd64602160e19a224d2d8f))

### Features

- **auth:** add export_action_items and manage_link permissions ([487c458](https://github.com/klarna/gram/commit/487c458fad2e4f208463bb5ecc81c847b9d071a4))
...
- :bug: fix sql queries for resource matching ([9f96e33](https://github.com/klarna/gram/commit/9f96e3349850bc8bd050b2a041538fc2577752bd))

## [4.22.1](https://github.com/klarna/gram/compare/v4.22.0...v4.22.1) (2025-02-19)

### Bug Fixes

- :bug: fix validation on resource-matching api routes ([905bfc6](https://github.com/klarna/gram/commit/905bfc62d4f122ba519527f056983b3fc7b84a97))
